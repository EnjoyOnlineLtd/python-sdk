...
from qiniu4tornado.utils import urlsafe_base64_encode, crc32, file_crc32, _file_iter
...
class _Resume(object):
    ...
    http://developer.qiniu4tornado.com/docs/v6/api/reference/up/mkblk.html
    http://developer.qiniu4tornado.com/docs/v6/api/reference/up/mkfile.html
